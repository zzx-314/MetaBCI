...
for i in range(fold):
    ...
    shap_values = explainer.shap_values(val_feature[100:150])
    val_feature_reshaped = np.mean(val_feature[100:150], axis=(1, 3))  # (50, 11)
